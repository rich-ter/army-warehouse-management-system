...
var handleRenderChart = function() {
	...
	Chart.defaults.plugins.tooltip.color = app.color.bodyBg;
	Chart.defaults.plugins.tooltip.multiKeyBackground = app.color.inverse;
	Chart.defaults.plugins.tooltip.backgroundColor = app.color.inverse;
